...
The specification is a flat mapping, without internal referencing, that can
be stored in either YAML or JSON format.

(NOTE: An internally referential rendition may be provided too, in YAML and
JSYNC.)
