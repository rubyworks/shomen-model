...
You can copy anyone of those repos to your website (e.g. site/) and run with it.
If you want to try it out locally, Shomen provides a static server to make it easy.
